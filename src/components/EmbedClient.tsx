    ...
    <div className="min-h-screen bg-zinc-50 text-zinc-900">
      ...
      <div className="flex justify-center px-4 py-14">
        ...
        >
          ...
          <p>
            Copy and paste this code before <code>&lt;/body&gt;</code> tag.
          </p>
          <div className="relative bg-zinc-900 text-zinc-100 rounded-xl p-5 text-sm font-mono mb-10">
            ...
            <button
              onClick={copyCode}
              className="absolute top-3 right-3 bg-white text-zinc-900 text-xs font-medium px-3 py-1.5 rounded-lg
              ...
              <div className="relative h-64 sm:h-72 p-6 text-zinc-400 text-sm">
                ...
                <div className="absolute bottom-24 right-6 w-64 bg-white rounded-xl shadow-xl border border-zinc-200 overflow-hidden">
                  ...
                  <div className="p-3 space-y-2 bg-zinc-50">
                    ...
                    <div className="bg-black text-zinc-200 text-xs px-3 py-2 rounded-lg ml-auto w-fit">
                ...
                <motion.div
                  ...
                  className="absolute bottom-6 text-xl right-6 w-14 h-14 rounded-full bg-black text-white flex items-center justify-center shadow-2xl cursor-pointer"
                >
                  🗨️
                </motion.div>
              </div>
